...
public class WheelView extends View {
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFF4AAF4C;
    public static final int TEXT_COLOR_NORMAL = 0XFF4C4C4E;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = (int) (density * TEXT_SIZE);
        judgeLineSpace();
        initView(context);
    }
    ...
    public void setPadding(int padding) {
        this.padding = DimensionUtil.dp2Px(padding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (padding < 0) {
                padding = DimensionUtil.dp2Px(ITEM_PADDING);
            }
    ...
    private void measureTextWidthHeight() {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            Paint.FontMetrics metrics = paintCenterText.getFontMetrics();
            centerContentOffset = metrics.descent;
